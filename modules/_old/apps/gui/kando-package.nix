...
buildNpmPackage.override { inherit nodejs; } rec {
  ...
  src = fetchFromGitHub {
    owner = "kando-menu";
    repo = "kando";
    rev = "8ed96ee3d9f08564ada24b9a1cb7a7e22f2c8185";
    sha256 = "sha256-XBUvrNXpDDE9U3S2jFww7Gk1r44ve/oAPFhoqSbVoTA=";
  };

  npmDepsHash = "sha256-Qh8L5QB+HKUdalwJpxfO1MQCydhH3gJ9Mekz5tBXAmA=";
